...
def test_maverick_config_defaults():
    """Test MaverickConfig initializes with default values."""
...
def test_maverick_config_custom_values():
    """Test MaverickConfig with custom values."""
    config = MaverickConfig(
