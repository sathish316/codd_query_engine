...
from codd_engine.querygen_engine.custom_tool.spl_validator_tool import (
    ...
    def _init_agent(self):
        ...
        self.agent = (
            ...
            .instruction(
                ...
                expand_path("$HOME/.codd/prompts/agent/logs/SPLUNK_SPL_QUERY_GENERATOR_AGENT_INSTRUCTIONS.md"),
            )
