...
1. **MetricsSemanticMetadataStore class** (depends on: none)
   - Main client class in `maverick-dal/metrics/metrics_semantic_metadata_store.py`
...
4. **Unit tests** (depends on: Core API methods)
   - Test file at `maverick-dal/metrics/tests/test_metrics_semantic_metadata_store.py`
...
- MetricsSemanticMetadataStore class implemented in `maverick-dal/metrics/metrics_semantic_metadata_store.py`
