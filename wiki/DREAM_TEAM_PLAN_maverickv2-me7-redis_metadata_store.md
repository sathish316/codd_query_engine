...
1. **MetricsMetadataClient class** (depends on: none)
   - Main client class in `maverick-dal/metrics/metrics_metadata_client.py`
...
4. **Unit tests** (depends on: Core API methods)
   - Test file at `maverick-dal/metrics/tests/test_metrics_metadata_client.py`
...
- [ ] MetricsMetadataClient class is implemented in `maverick-dal/metrics/metrics_metadata_client.py`
