# Maverick MCP Server - Cursor Usage Guide

AI-powered observability tools accessible via MCP (Model Context Protocol) in Cursor and other MCP clients.

## Overview

The Maverick MCP Server provides four powerful tools for observability:
...
Add the Maverick MCP server to your Cursor MCP settings:
...
In Cursor, you should see the Maverick tools available. You can verify by:
1. Opening Cursor Settings → MCP
2. Checking that "maverick" server is listed and connected
3. Looking for the 4 Maverick tools in the available tools list
