...
class SplunkSPLValidatorTool(CustomTool):
    """
    Tool for validating Splunk SPL queries.
    """

    def __init__(self, log_query_validator: LogQueryValidator):
        super().__init__(name="spl_validator_tool", config_key="logs.splunk.validator")
        ...
        def validate_spl_query(
            ...
            **kwargs,
            ...
            Args:
                ...
                backend: The backend to validate against (should be "splunk")
